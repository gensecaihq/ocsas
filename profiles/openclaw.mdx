...
- Models maintained in [openclaw-formal-models](https://github.com/vignesh07/openclaw-formal-models)
...
**Negative Models:**
```bash
# These MUST fail (produce counterexamples)
...
- Repo vendors pinned `tla2tools.jar`
